    ...
    <StyledHowItWorksSection id="how-it-works" className="how-it-works">
      <Container>
        <StyledFlex className="how-it-works-contents">
          ...
          <StyledFlexColumn alignItems="flex-start" className="ml-20" alignSelf="center">
            <SectionHeader
            ...
            <StyledFlexColumn className="mt-20">
              <StyledFlexAlignCenter className="mt-20">
            ...
            <OutboundLink target="_blank" href={howItWorksSection.href} className="mt-40">
